...
module.exports = function (app) {
    ...
    bubbleRouter.get('/:cid/comments/:last?',verifyMiddleware, bubbleController.getBubbleComments);
    bubbleRouter.post('/:cid/comment',verifyMiddleware, bubbleController.addBubbleComment);
